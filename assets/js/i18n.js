...
window.I18N = {
  en: {
    ...
    "view.map": "Map",
    "map.buildings": "Buildings come from OpenStreetMap. Fewer than one in ten of Malé's mapped buildings records a height, so most are drawn at an assumed one. Read the massing as density, not as a survey.",
    "map.reset": "Face north and flatten",
    ...
    "tree.credit": "Recorded by",
    "tree.asNamed": "Called locally",
    "tree.recorded": "Added",
  ...
  dv: {
    ...
    "view.map": "ޗާޓު",
    "map.buildings": "ޢިމާރާތްތަކުގެ މަޢުލޫމާތަކީ OpenStreetMap އިން ލިބޭ މަޢުލޫމާތެވެ. މާލޭގައި ރެކޯޑް ކުރެވިފައިވާ ޢިމާރާތްތަކުގެ ދިހަބައިކުޅަ އެއްބަޔަށްވުރެ މަދު ޢިމާރާތެއްގައި އުސްމިން ހިމެނެއެވެ. އެހެންކަމުން ގިނަ ޢިމާރާތްތައް ދައްކާފައިވަނީ އަންދާޒާ އުސްމިނެއްގައެވެ.",
    "map.reset": "އުތުރަށް އަނބުރާ",
    ...
    "tree.evidence": "ހެކި",
    "tree.credit": "ރެކޯޑް ކުރީ",
    "tree.asNamed": "މީހުން ކިޔާ ނަން",
