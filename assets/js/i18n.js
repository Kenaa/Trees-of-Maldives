...
window.I18N = {
  en: {
    ...
    "submit.privateHint": "Worth recording. A tree in a courtyard has different protection, and anyone going to measure it needs to ask first.",
  ...
  dv: {
    ...
    "submit.privateHint": "ރެކޯޑް ކުރުން މުހިންމު. ގޯތިތެރޭގައި ހުންނަ ގަހަކަށް ލިބޭ ރައްކާތެރިކަން ތަފާތު، އަދި މިނަން ދާ މީހަކު ހުއްދަ ހޯދަން ޖެހޭނެ.",
