...
A citizen archive of the trees still standing in Malé City — and a record of the ones
that were cut down.
...
That is the only change needed. Also set `contactEmail` either way — it is the fallback
